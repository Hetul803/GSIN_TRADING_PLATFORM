...
# Get DATABASE_URL from .env file or environment variable
...
# Set the database URL - need to escape % for ConfigParser
# ConfigParser interprets % as interpolation, so we double it
if "%" in database_url:
